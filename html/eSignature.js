...
var app = new Vue({
    ...
    data: {
        ...
        sameYes : false, //同账号 by gary-付款账号与给付账号为同一账号且只是唯一一个
        TerrName:'',  //开户地
        ...
        accChangeData:{
            holderName : '', //账户持有姓名  
            bankCode:'',//银行编号001，004之类 houjin
            bankName:'',//银行名称 农行，建行等 houjin
            accountNum:'',//银行卡号 houjin
            accountbranch:'',//开户分行 houjin
            accountPlace:''//开户地 houjin
        },
        ...
        sxIdiea:true,//被保险人与投保人声明显示状态 houjin
        ...
        signState:[],  //电子签名 完成进度
        sqState:false,  //by gary-转账授权书显示状态
        ...
        showFnaCQ: false, //by gary-重庆财务分析问卷
        showFnaNB: false, //by gary-宁波财务分析问卷
        ...
        confirmDocumentList: [],//by gary-同意文档的勾选列表
        ...
        commentModal: false, //non use
        signModal: false,  //non use
        recoModal: false,  //by gary-持证拍照弹框的显示状态
        recoCliNum: '', //by gary-人脸识别选中的cliNum
        recoTime: 0, //non use
        bioFacialFailedCount: 0, //by gary-人脸识别失败的次数
        bioFacialFailedCountLen:3,
        showWithID: false, //by gary-人脸识别的显示状态
        canPhoto:true, //non use
        readAuth: false, //by gary-人脸识别授权协议书》同意状态
        authBookModal: false, //by gary-人脸识别授权协议书弹框显示状态
        showBankTransfer: false, //by gary-银行自动转账授权协议书显示状态
        inputBankTransfer: false, //by gary-转账授权书（未确认）/转账授权书 显示状态
        inputFinancial: false, //by gary-财务问卷（未填写）/财务问卷 显示状态
        bankList: [], //by gary-银行列表
        ocrbankList: [],
        bankFormItem: {
            polNum: '',
            accountList: []
        }, //by gary-转账授书展示数据
        showFinancial: false, //by gary-财务问卷组件的显示状态
        financialFormItem: {
            financialInfoList: []
        }, //by gary-财务问卷组件的展示数据
        uploadList: [],
        ...
        panelValue2: [1,2], //by gary-账号修改的展示项目
        accountData:[],  //non use
        switch2:false,   //by gary-修改账号分割线的显示状态
        disabledSingle: true, 
        disabledGroup: '投保人', //by gary-扣款账号账户持有人勾选的值
        IsSameAsInsured:false,//扣款账号账户持有人的禁用状态 houjin
        // 扣款账号
        deductionAccount: [],
        // 给付账号
        paymentAccount:[]
