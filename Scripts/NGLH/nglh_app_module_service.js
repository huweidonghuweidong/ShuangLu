...
// Service
// //////////////////////////////
nglh_app_module.service('nglhAppService', ['$q', '$filter',
    function ($q, $filter) {
        var handleHttpError = function (description, jqXHR, textStatus, errorThrown) {
            //20191420 GMMW 产品流程问题修复
            var _errMsg;
            if (jqXHR != null && jqXHR != undefined) {
                _errMsg = "description:" + description + ",jqXHR.statusText:" + jqXHR.statusText + ",jqXHR.readyState :" + jqXHR.readyState + ",textStatus:" + textStatus + ",errorThrown:" + errorThrown;
            }
            else {
                _errMsg = "description:" + description;
            }
            //20191420 GMMW 产品流程问题修复
        ...
        this.save = function (eAppData, showErrorMsg) {
            ...
            $.ajax({
                url: '../nglhApplication/REST/SaveData',
                data: eAppData,
                method: 'post',
                async: true,
                timeout: 240000
        ...
        //<<20200443
        this.CheckIsHealCaseWord = function () {

            var result;

            $.ajax({
                type: 'post',
                url: 'CheckIsHealCaseWord',
                async: false,
                success: function (data) {
                    result = data;
                },
        ...
        this.loadAvailablePlanList = function (prodCode) {
            ...
            $.ajax({
                type: 'get',
                url: '../nglhApplication/REST/LoadAvailablePlanList?ProdCode=' + prodCode,
                dataType: 'json',
                async: false
            }).done(function (data) {
                result = data;
        ...
        this.getProductSection = function (prodCode, type) {

            var result;

            $.ajax({
                type: 'get',
                url: 'GetProductSection?name=' + prodCode + "&type=" + type,
                async: false,
                success: function (data) {
                    result = data;
                },
        ...
        this.getProductPlanInfo = function (prodCode, type) {

            var result;

            $.ajax({
                type: 'get',
                url: 'GetProductPlanInfo?name=' + prodCode + "&type=" + type,
                async: false,
                success: function (data) {
                    result = data;
                },
        ...
        this.getProductPlanDesc = function (index) {

            var result;

            $.ajax({
                type: 'get',
                url: 'GetProductPlanDesc?index=' + index,
                async: false,
                success: function (data) {
                    result = data;
                },
        ...
        this.loadProductNoticePreview = function (prodCode) {

            var result;

            $.ajax({
                type: 'get',
                url: 'GetProductNotice?name=' + prodCode,
                async: false,
                success: function (data) {
                    result = data;
                },
        ...
        //    $.ajax({
        //        type: 'get',
        //        url: '../nglhApplication/REST/LoadDeductiblesList',
        //        dataType: 'json',
        //        async: false
        //    }).done(function (data) {
        //        result = data;
        ...
        //zheng 获取省名称 20186222
        this.loadProvince = function (code) {
            var output;
            var provinceLst = this.loadProvinceList();
            for (var i = 0; i < provinceLst.length; i++) {
                if (provinceLst[i].key == code) {
                    output = provinceLst[i].value;
                    break;
                }
            }
            return output
        ...
        //zheng 获取市 20186222
        this.loadCity = function (proviceCode, cityCode) {
            var resultList = []
            var result;
            resultList = this.loadTerritoryList(proviceCode);
            for (var i = 0; i < resultList.length; i++) {
                if (resultList[i].key == cityCode) {
        ...
        this.loadApplicationData = function (appNum) {
            ...
            $.ajax({
                type: 'get',
                url: '../nglhApplication/REST/GetApplicationData?appNum=' + appNum,
                dataType: 'json',
                async: false
            }).done(function (data) {
                result = data;
        ...
        this.loadApplicationSummary = function (appNum) {
            ...
            $.ajax({
                type: 'get',
                url: '../nglhApplication/REST/GetApplicationSummary?appNum=' + appNum,
                dataType: 'json',
                async: false
            }).done(function (data) {
                result = data;
        ...
        this.loadSignTerrCdList = function (resourceId) {
            ...
            $.ajax({
                type: 'get',
                url: '../nglhApplication/REST/GetSignTerrCdList?resourceId=' + resourceId,
                dataType: 'json',
                async: false
            }).done(function (data) {
                result = data;
        ...
        this.getCurrenProdCode = function () {
            var result = {};

            $.ajax({
                type: 'get',
                url: 'GetCurrenProdCode',
                dataType: 'json',
                async: false
            }).done(function (data) {
                result = data;
        ...
        this.GetClientPlanSummary = function (AppNum, ProCode) {
            var result = [];

            $.ajax({
                type: 'get',
                url: 'GetClientPlanSummary?AppNum=' + AppNum + '&ProCode=' + ProCode,
                dataType: 'json',
                async: false
            }).done(function (data) {
                result = data;
        ...
        this.postCurrent = function postCurrent(url, params) {
        ...
        this.GetClientPlanDetail = function (appNum) {
            ...
            $.ajax({
                ...
                handleHttpError("网络繁忙，请稍后重试<br/>unable to get GetClientPlanDetail  (" + appNum + ")", jqXHR, textStatus, errorThrown);
                result = null;
            });
        ...
        this.loadPaymentDataList = function (appNum) {
            ...
            $.ajax({
                type: 'get',
                url: '../nglhApplication/REST/GetPaymentDataList?appNum=' + appNum,
                dataType: 'json',
                async: false
            }).done(function (data) {
                result = data;
        ...
        this.loadOtherInsuredDataList = function (appNum) {
            ...
            $.ajax({
                type: 'get',
                url: '../nglhApplication/REST/GetOtherInsuredDataList?appNum=' + appNum,
                dataType: 'json',
                async: false
            }).done(function (data) {
                result = data;
        ...
        //            var deferred = $q.defer();
        //            $.ajax({
        //                url: '../nglhApplication/REST/InitialSave',
        //                data: eAppData,
        //                method: 'post',
        //                async: true,
        //                timeout: 240000
        ...
        //            var deferred = $q.defer();
        //            $.ajax({
        //                url: '../nglhApplication/REST/SavePaymentData',
        //                data: eGLHAppData,
        //                method: 'post',
        //                async: true,
        //                timeout: 240000
        ...
        this.getDocumentList = function (result) {
            var msg = "<pre>恭喜您！您提交的保单：" + result.AppNum + "已进入核心系统，在线投保流程已完成！";
            msg = msg + "<br/> " + "温馨提示：请您在3个工作日内将以下材料交回公司：";
            var num = 1;
            for (var idx in result.DocList) {

                msg = msg + "<br/>" + num + ".-" + result.DocList[idx];
                num = num + 1;
            }
        ...
        this.loadApplicationListData = function (rqstData) {
            ...
            $.ajax({
                method: 'get',
                url: '../nglhApplication/REST/GetApplicationList',
                data: rqstData,
                dataType: 'json',
                async: false
            }).success(function (data) {
        ...
        this.getAllDocuments = function (eAppNumber) {
            ...
            $.ajax({
                type: 'post',
                url: '../nglhApplication/REST/Documents/' + eAppNumber,
                dataType: "json",
                async: false,
                success: function (data) {
        ...
        this.loadDeductiblesList = function (prodCode) {
            ...
            $.ajax({
                type: 'get',
                url: '../nglhApplication/REST/LoadDeductiblesList?ProdCode=' + prodCode,
                dataType: 'json',
                async: false
            }).done(function (data) {
                result = data;
        ...
        this.callMsleHomeImageUpload = function (eAppNumber) {
            var result = null;
            $.ajax({
                url: '../nglhApplication/REST/ImageUpload',
                method: 'POST',
                data: {
        ...
        this.getStepDefinition = function () {
            ...
            $.ajax({
                type: 'get',
                url: '../nglhApplication/REST/GetStepDefinition/',
                dataType: "json",
                async: false,
                success: function (data) {
                    result = data;
        ...
        //<<King_GMMW
        this.copyPolicy = function (appNum) {
            var result = "";
            $.ajax({
                url: '../nglhApplication/REST/CopyPolicy?appNum=' + appNum,
                method: 'post',
                async: false,
                timeout: 240000
            }).success(function (data) {
        ...
        //<<20200558
        this.checkAppAgent = function (agentCode) {
            var result = "";
            $.ajax({
                url: '../nglhApplication/REST/CheckAppAgent',
                method: 'post',
        ...
        this.loadPendingEGLHAppData = function (appNum) {
            ...
            $.ajax({
                type: 'get',
                url: '../nglhApplication/REST/LoadPendingEGLHAppData?appNum=' + appNum,
                dataType: 'json',
                async: false
            }).done(function (data) {
                result = data;
        ...
        this.loadOccupation = function () {
            ...
            $.ajax({
                type: 'get',
                url: '../nglhApplication/REST/LoadOccpationData',
                dataType: 'json',
                async: false
            }).done(function (data) {
                result = data;
        ...
        this.loadDuplicateConfirmNumber = function (code) {
            ...
            $.ajax({
                type: 'get',
                url: '../nglhApplication/REST/LoadConfirmNumber?confirmNum=' + code,
                dataType: 'json',
                async: false
            }).done(function (data) {
                result = data;
...
//                    }
    ...
    nglh_app_module.config(['$translateProvider',
    function ($translateProvider) {
        var result = null;

        $.ajax({
            type: 'get',
            url: '../nglhApplication/REST/ValidationMessages',
            dataType: "json",
            async: false,
            success: function (data) {
